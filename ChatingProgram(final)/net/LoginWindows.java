    ...
    public void login() {
        ...
        c.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		...
        		j1.setBounds(125,290,80,30); j2.setBounds(240,290,80,30);
        		...
        		j1.addActionListener(new ActionListener() {
        			public void actionPerformed(ActionEvent T) {
        				try {
        					db.createAccount(t1.getText(), t4.getText(), t3.getText(), t6.getText(), t5.getText(), t7.getText(), t8.getText(), t2.getText());
